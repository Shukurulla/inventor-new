...
const CreateEquipmentModal = ({
  ...
  const handleStep2Submit = async () => {
    try {
      ...
      setCurrentStep(3); // ИНН step'ga o'tish
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Выбор или создание характеристик",
    },
    {
      title: "ИНН",
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium">
              Выбор характеристикwdasdasdasdasd
            </h3>
            <Button
              type="dashed"
              icon={<FiPlus />}
          ...
          {availableSpecs.length > 0 ? (
            <div>
              <Form.Item
                ...
                name={specFieldName}
                rules={[
                  { required: true, message: "Выберите характеристику!" },
                ]}
              >
                <Select
            ...
            <div className="text-center py-6 mb-4">
              ...
              <p className="text-sm text-gray-400">
                Создайте новую характеристику, используя кнопку выше
              </p>
            </div>
          )}
        </div>
  ...
  const renderStep3 = () => (
    <div>
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-medium">Создание оборудования</h3>
        </div>

        <div className="text-center py-8">
          <div className="text-lg font-medium text-gray-800 mb-4">
            Готовы создать оборудование?
          </div>
          <div className="text-gray-600 mb-6">
            На основе выбранных характеристик будет создано{" "}
            <span className="font-medium">
              {form.getFieldValue("count")} единиц
            </span>{" "}
            оборудования типа{" "}
            <span className="font-medium">
              {
                equipmentTypes.find(
                  (t) => t.id === form.getFieldValue("type_id")
                )?.name
              }
            </span>
          </div>
